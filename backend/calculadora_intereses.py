...
class CalculadoraIntereses:
    ...
    def obtener_tasa_oficial(self, tipo_tasa="TEA"):
        try:
            ...
            # Si falla, devuelve la última tasa guardada
...
# ---------------------------------------------------------
# 🔹 FUNCIÓN EXPORTADA PARA FASTAPI (Opción 1)
# ---------------------------------------------------------

calc = CalculadoraIntereses()

def calcular_intereses(capital, fecha_inicio, fecha_fin, tipo_tasa="TEA"):
    return calc.calcular(capital, fecha_inicio, fecha_fin, tipo_tasa)
